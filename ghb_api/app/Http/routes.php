...
{	
	...
	Route::get('reference_target_list','AppraisalItemController@getReferenceTargetList');
	...
	Route::get('org/master/org_list_transection', 'OrgController@org_list_transection');
	Route::get('org/master', 'OrgController@org_master');
	...
	Route::get('dashboard/list_appraisal_level', 'AppraisalController@list_appraisal_level');
	Route::get('dashboard/list_organization', 'OrgController@list_organization');
