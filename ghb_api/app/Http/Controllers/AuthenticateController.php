...
class AuthenticateController extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		$emp = DB::select("
			select b.level_id,b.is_hr, a.is_show_corporate
			from employee a
		...
		return response()->json(['status' => 200, 'theme_color' => $config->theme_color, 'is_hr' => $emp[0]->is_hr, 'level_id'=> $emp[0]->level_id, 'is_show_corporate' => $emp[0]->is_show_corporate ]);
    }    
...
From Going Jesse Team
    ...
    {	
      //  $credentials = $request->only('username', 'password');
        ...
        return response()->json(['token' => $token, 'theme_color' => $config->theme_color, 'is_hr' => $emp[0]->is_hr, 'level_id'=> $emp[0]->level_id, 'is_show_corporate' => $emp[0]->is_show_corporate ]);
    }
